...
function InformationEdit() {
  //title page
  document.title = 'Edit Information - Administrator Administrator Si Asri'
  ...
  const getInformationById = async () => {
    ...
    const response = await Api.get(`/api/admin/informations/${id}`, {
      //header
      headers: {
        //header Bearer + Token
  ...
  const updateInformation = async (e) => {
    ...
    await Api.post(`/api/admin/informations/${id}`, formData, {
      //header
      headers: {
        //header Bearer + Token
        Authorization: `Bearer ${token}`,
            ...
            <div className='card border-0 rounded shadow-sm border-top-success'>
              <div className='card-header'>
                <span className='font-weight-bold'>
                  <i className='fa fa-folder'></i> EDIT INFORMATION
                </span>
              </div>
